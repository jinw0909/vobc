...
//                     {walletOptions.map(
//                         (option) => {
//                             const isCurrentWalletPending =
//                                 pendingAction?.type ===
//                                 'connect' &&
//                                 pendingAction.walletId ===
//                                 option.id
//
//                             return (
//                                 <button
...
function isAlreadyPendingRequestError(
    error: unknown,
) {
    if (
        !error ||

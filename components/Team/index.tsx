...
import engineering4 from '@/public/teams/profile/hunook.png';
...
import business4 from '@/public/teams/profile/minjung.png';
import business5 from '@/public/teams/profile/yunghoo.png';
...
const strategyPic = [strategy0, strategy1, strategy2, strategy3, strategy4, strategy5, strategy6, fallbackImg];
const businessPic = [business0, business1, business2, business3 ,business4, business5];
const tradingPic = [trading0, trading1, trading2, trading3];
